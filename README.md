...
| 	0x Portal	| 	[![alt text][web]](https://0x.org/portal) |	| | | 	(live)	| 	0x protocol	|	| | | | |
| 	0xchange	| 	[![alt text][web]](https://0xchange.me/) | [![alt text][github]](https://github.com/0xchange/0xchange)	| [![alt text][whitepaper]](https://devpost.com/software/0xchange-me) | | 	(live)	| 	0x protocol	| 	| | | | |
| Aermos | [![alt text][web]](http://www.aermos.com) |   | [![alt text][whitepaper]](http://www.aermos.com/concept/) | `FULLY` | (dead) | TBC |   | | | | |
|   AirSwap	| 	[![alt text][web]](https://www.airswap.io/) |	[![alt text][github]](https://github.com/airswap) | [![alt text][whitepaper]](https://swap.tech/whitepaper/) | | 	(live)	| 	swap protocol	|	| | | | |
| 	Allbit	| 	[![alt text][web]](https://allbit.com/) |	| [![alt text][whitepaper]](https://static-allbit.s3.amazonaws.com/guide/APOT_White%20paper_v.0.9.3._181005_revised.pdf) | 	TBC	| 	(live)	| 	Ethereum - Allbit Sidechain	| 3 | ERC20 Tokens | Ethereum | Ozys Co. Ltd. | |
...
| 	AMP	| 	[![alt text][web]](https://amp.exchange/) | [![alt text][github]](https://github.com/proofsuite)	| | | 	(live)	| 	| 3	| ERC20 Tokens | Ethereum | PROOF Suite | |
...
| 	Atom DEX	| [![alt text][web]](https://bitcoinatom.io/) | [![alt text][github]](https://github.com/bitcoin-atom) | | | 	(live - beta)	| atomic swap | 	| | Bitcoin Atom | | |
...
| 	B&C Exchange	| 	[![alt text][web]](https://bcexchange.org) | [![alt text][github]](https://bitbucket.org/JordanLeePeershares/bcexchange/src) | [![alt text][whitepaper]](https://bcexchange.org/assets/Blocks_&_Chains_Decentralized_Exchange.pdf) | | 	(live)	| 	bcexchange protocol	| 	| | | | |
| 	b0x	| 	[![alt text][web]](https://bzx.network/) | [![alt text][github]](https://github.com/bZxNetwork) | [![alt text][whitepaper]](https://bzx.network/pdfs/bZx_white_paper.pdf) | | 	(dev - TGE expected Q2 2018)	| 	b0x protocol (margin lending/trading and oracle marketplace)	| 	| | | | |
| 	Bamboo Relay	| 	[![alt text][web]](https://bamboorelay.com/)  | | | |	(live)	| 	0x protocol	| 	| ERC20 Tokens | Ethereum | | |
...
| 	BarterDEX	| [![alt text][web]](https://komodoplatform.com/)	 | [![alt text][github]](https://github.com/KomodoPlatform/Komodoplatform)	| [![alt text][whitepaper]](https://komodoplatform.com/wp-content/uploads/2018/06/Komodo-Whitepaper-June-3.pdf) | `FULLY` | 	(live)	| 	barterdex protocol	| 	| | | | |
...
| Bisq | [![alt text][web]](https://bisq.network/) | [![alt text][github]](https://github.com/bisq-network) | [![alt text][whitepaper]](https://docs.bisq.network/dao/phase-zero.html) | `FULLY` | (live) | Bisq protocol | 6 | | | | |
...
| Blackhalo | [![alt text][web]](http://blackhalo.info/) | [![alt text][github]](https://github.com/dzimbeck/Halo) | [![alt text][whitepaper]](http://blackhalo.info/wp-content/uploads/2014/06/whitepaper_twosided.pdf) | `FULLY` | (live - beta) | TBC |   | | | | |
...
| 	Block DX	| 	[![alt text][web]](https://blocknet.co/block-dx/) | [![alt text][github]](https://github.com/BlocknetDX/blockdx-ui)	| [![alt text][whitepaper]](https://docs.blocknet.co/project/blocknet-whitepaper.pdf) | `FULLY` | 	(live - beta)	| 	blocknet protocol	| 10 | All | N/A | None | |
| 	BlockEQ	| 	[![alt text][web]](https://www.blockeq.com/)  | [![alt text][github]](https://github.com/Block-Equity/) | | |	(live)	| 	stellar protocol	| 	| | Stellar | | |
...
| 	Coinchangex	| 	[![alt text][web]](https://www.coinchangex.com/) | 	| | | 	(live)	| 	TBC	| 	| | | | |
| 	Coinffeine	| 	[![alt text][web]](https://www.coinffeine.com/) | [![alt text][github]](https://github.com/Coinffeine)	| | | 	(dev)	| 	coinffeine protocol	| 	| | | | |
| 	COMIT	| 	[![alt text][web]](https://www.comit.network/) | [![alt text][github]](https://github.com/comit-network) | [![alt text][whitepaper]](https://www.comit.network/doc/COMIT%20white%20paper%20v1.0.2.pdf) | | 	(whitepaper)	| 	comit protocol (cross-chain routing)	|	2 | | | | |
...
| 	Counterparty DEX | 	[![alt text][web]](https://wallet.counterwallet.io/#pages/exchange.html) | [![alt text][github]](https://github.com/CounterpartyXCP/)	| [![alt text][whitepaper]](https://counterparty.io/docs/api/) | | 	(live)	| 	counterparty protocol	|	| Bitcoin - Counterparty Tokens | Bitcoin | | |
| 	CoX | 	 | [![alt text][github]](https://github.com/SmartChainX/CoX-SmartContracts)	| | | 	(dead)	| 	cox protocol	|	| | | | |
| 	Crypto Bridge	| 	[![alt text][web]](https://wallet.crypto-bridge.org/) |	[![alt text][github]](https://github.com/CryptoBridge/cryptobridge-ui) | | | 	(live)	| 	bitshares protocol (DPOS)	| 	| | | | |
| 	CryptoDerivatives	| 	[![alt text][web]](https://cryptoderivatives.market) | [![alt text][github]](https://github.com/bokkypoobah/TokenTrader) | [![alt text][whitepaper]](https://github.com/bokkypoobah/TokenTrader/wiki) | | 	(live)	| 	on-chain 	| 	| | Ethereum | | |
| 	Cybex	| 	[![alt text][web]](https://dex.cybex.io/) |	| | | 	(live)	| 	bitshares protocol (Graphene)	| 	| | | | |
|  DC-Ex	| 	[![alt text][web]](https://www.dc-ex.com/) |	| | | 	(live)	| 	TBC	| 	| | | | |
| 	DDEX	| 	[![alt text][web]](https://ddex.io/trade/) | [![alt text][github]](https://github.com/HydroProtocol/protocol) | [![alt text][whitepaper]](https://docs.ddex.io/) | | 	(live)	| 	0x protocol	| 	| | | | |
| 	DEAL	| 	 |	| [![alt text][whitepaper]](https://aphelion.org/wp.html) | | 	(dead)	| 	deal protocol	| 2	| NEO Assets | NEO | | |
| 	Decred	| 	[![alt text][web]](https://www.decred.org/) | [![alt text][github]](https://github.com/decred/atomicswap/)	| [![alt text][whitepaper]](https://github.com/decred/atomicswap/blob/master/README.md) | | (live)	| 	decred cross-chain atomic swapping protocol	| 	| | | | |
| 	Deex	| 	[![alt text][web]](https://deex.exchange/) |	| | | 	(dev)	| 	bitshares protocol (Graphene)	| 	| | | | |
| 	DECENT EX	| 	[![alt text][web]](https://decent.exchange/) |	| | | 	(live - beta)	| 	0x protocol	| 	| | Ethereum | | |
...
| DEXEOS | [![alt text][web]](https://dexeos.io/) | [![alt text][github]](https://github.com/DEXEOS) |   | `FULLY` | (live) | EOS |   | | EOS | WIZLAB  | |
...
| 	Dextroid	| 	[![alt text][web]](https://www.dextroid.io/) |	| | | 	(live - beta)	| 	0x protocol	| 	| | | | |
...
| DUBIex |  [![alt text][web]](https://dubiex.com/) | [![alt text][github]](https://github.com/nionis/dubiex/) |  |   | (live) | TBC |   |   |   |   |   |
...
| 	EasyTrade	| 	[![alt text][web]](https://easytrade.io/) |	| | `FULLY` | 	(live)	| 	0x protocol	|	| | | | |
| Eidoo | [![alt text][web]](https://eidoo.io/) | [![alt text][github]](https://github.com/eidoo) | [![alt text][whitepaper]](https://eidoo.io/white-paper/) | `DCD` | (live) | multi protocol | 3 | | | | |
| 	Enclaves	| 	[![alt text][web]](https://enclaves.io/) | [![alt text][github]](https://github.com/adamdossa)	| | | 	(live)	| 	0x protocol	| 	| | Ethereum | | |
...
| 	ERC dEX	| 	[![alt text][web]](https://app.ercdex.com/) |	| | | 	(live)	| 	0x protocol	| 	| | | | |
|	Eth2Dai	| [![alt text][web]](https://eth2dai.com/)	| [![alt text][github]](https://github.com/OasisDEX/eth2dai) |  | `FULLY` | 	(live)	| 	on-chain protocol	|  | ERC20 Tokens | Ethereum | Maker DAO |  |
| 	Ethen Market	| 	[![alt text][web]](https://ethen.market) | [![alt text][github]](https://github.com/ethenmarket)	| | | (live)	| 	on-chain protocol	| 3	| ERC20 Tokens | Ethereum | | |
| 	ETHERC	| 	[![alt text][web]](https://etherc.io/) | [![alt text][github]](https://github.com/ETHERCIO)	| [![alt text][whitepaper]](https://medium.com/@etherc_io/) | `FULLY` | 	(live)	| 	on-chain protocol	| 	| | | | |
| 	EtherDelta	| 	[![alt text][web]](https://etherdelta.com) | [![alt text][github]](https://github.com/etherdelta/etherdelta.github.io)	| | `FULLY` | 	(live)	| 	on-chain protocol	| Ethereum	| | | | |
| 	EtherEx	| 	[![alt text][web]](http://etherex.github.io/etherex) | [![alt text][github]](https://github.com/etherex/etherex)	| | | 	(live)	| 	TBC	| 	| | | | |
| 	EtherFlyer	| 	[![alt text][web]](https://www.etherflyer.com/) |	| | | 	(live)	| 	TBC	| 	| | | | |
| 	EtherMium	| 	[![alt text][web]](https://ethermium.com/) |	| | | 	(live)	| 	TBC	| 	| ERC20 Tokens | Ethereum | | |
| 	EtheRoox	| 	[![alt text][web]](http://etheroox.com) | [![alt text][github]](https://github.com/ynzheng/etheroox.github.io)	| | | 	(dev)	| 	TBC	| 	| | | | |
| 	Ether Wager	| 	[![alt text][web]](http://eth-wager.surge.sh/) |	| | | 	(live)	| 	oraclize protocol	| 	| | | | |
...
|	Fetch	| [![alt text][web]](https://hellofetch.co/)	|  |  |  | 	(live)	| | 4 |  |  | |  |
...
| 	Forkdelta	| 	[![alt text][web]](https://forkdelta.github.io) |	[![alt text][github]](https://github.com/forkdelta/) | | | 	(live)	| 	on-chain protocol	| 	| | | | |
| 	Freedom Dex	| 	[![alt text][web]](https://freedomdex.io/) |	| | | 	(live)	| 	TBC	| 	| | | | |
...
| 	GDEX	| 	[![alt text][web]](https://www.gdex.io/) |	| | | 	(live)	| 	bitshares protocol (DPOS)	| 	| | | | |
...
| 	Graphene	| 	[![alt text][web]](http://docs.bitshares.eu//index.html) |	| | | 	(live)	| 	bitshares protocol (Graphene)	| 2	| | | | |
| 	Heat	| 	[![alt text][web]](https://heatwallet.com) |	[![alt text][github]](https://github.com/Heat-Ledger-Ltd/) | [![alt text][whitepaper]](https://https://heatledger.com/HEATWhitepaper.pdf) | | 	(live)	| 	asset-to-asset protocol	| 	| | | | |
...
| 	Hodl Hodl	| 	[![alt text][web]](https://hodlhodl.com/) |	| | `DCD` `DSTT` | 	(live)	|  | 3 | | | | |
| 	Hodl⚡️co	| 	[![alt text][web]](http://www.hodlco.io) |	| | | 	(dev)	| 	TBC | 6	| | | | |
| 	IDEX	| 	[![alt text][web]](https://idex.market/) |	| | | 	(live)	| 	snowglobe protocol	| 	| | | | |
| 	IDT Exchange	| 	[![alt text][web]](https://trade.idtexchange.com/) |	| | | 	(live)	| 	0x protocol	| 	| | | | |
...
| INSTEX | [![alt text][web]](https://app.instex.io/)|	| | | (live)	| 	0x protocol	| 	| | Ethereum | | |
| Interstellar | [![alt text][web]](https://interstellar.exchange/)|	| | `FULLY` | (live)	| 	stellar protocol	| 	| | Stellar | | |
...
| 	LAtoken	| 	[![alt text][web]](http://www.latoken.com/) |	| | | 	(live)	| 	spectre protocol (DAG)	| 	| | | | |
|   LedgerDex |   [![alt text][web]](https://www.ledgerdex.com/) | [![alt text][github]](https://github.com/ledgerdex)  | | |   (live - beta)  |   0x protocol |   | | | | |
...
| 	Loopring	| 	[![alt text][web]](https://loopring.org) | [![alt text][github]](https://github.com/loopring) 	| [![alt text][whitepaper]](https://github.com/Loopring/whitepaper/raw/master/en_whitepaper.pdf) | | 	live	| 	loopring protocol	| 2	| ERC20 Tokens | Ethereum | | |
| 	LQDEX	| 	[![alt text][web]](https://lqdex.com) |	| [![alt text][whitepaper]](https://lqdex.com/doc/LQDEX-Whitepaper.pdf) | | 	(dev)	| 	cross-chain protocol	| | | | | |
| 	Lykke	| 	[![alt text][web]](https://www.lykke.com/exchange) | [![alt text][github]](https://github.com/LykkeCity/)	| [![alt text][whitepaper]](https://www.lykke.com/media/Whitepaper_LykkeExchange.pdf) | | 	(live)	| 	TBC	| 4	| | | | |
...
| Melon | [![alt text][web]](https://melonport.com/) | [![alt text][github]](https://github.com/melonproject/) | [![alt text][whitepaper]](https://github.com/melonproject/paper/blob/master/melonprotocol.pdf) |   | (live) | melonport protocol | 2 | ERC20 Tokens - Melon Fund Shares | Ethereum | | |
...
| 	MyEtherSwap	| 	[![alt text][web]](https://www.myetherswap.com/) |	| | | 	(live)	| 	TBC	| 	| | | | |
| 	NebliDex	| 	[![alt text][web]](https://neblidex.xyz/) |	| [![alt text][whitepaper]](https://www.neblidex.xyz/neblidex_whitepaper.pdf) | | 	(live)	| NTP1 / Cross chain protocol	| | | Neblio | | |
| 	NEX	| 	[![alt text][web]](https://neonexchange.org/) |	| | | 	(dev - launch Q3 2018)	| 	off-chain protocol	| 	| | | | |
| 	NIX	| 	[![alt text][web]](https://nixplatform.io/) | [![alt text][github]](https://github.com/nixplatform/)	| [![alt text][whitepaper]](https://nixplatform.io/docs/NIX-Platform-Whitepaper.pdf) | `FULLY` | 	(live)	| 	ghost protocol	| | | cross-chain | | |
...
| 	Nxt	| 	[![alt text][web]](https://nxtplatform.org) |	| | | 	(live)	| 	TBC	| 5	| | | | |
...
| 	Omni DEX	| 	[![alt text][web]](http://omniexplorer.info/dex.aspx) |	| | | 	(live)	| 	TBC	| 	| | | | |
...
| 	PlutusDEX |	[![alt text][web]](https://dex.plutus.it/) | | | |	(live) |	TBC |	 | | | | |
...
| 	Radar Relay	| 	[![alt text][web]](https://app.radarrelay.com/) | [![alt text][github]](https://github.com/RadarRelay)	| | `ACL` `DCD` | 	(live - beta)	| 	0x protocol	| 	| | | | |
| 	Radex	| 	[![alt text][web]](https://exchange.rados.io) | [![alt text][github]](https://github.com/rados-io/radex)	| | | 	(live - alpha)	| 	saturn protocol	|	| | | | |
...
| 	Rektex	| 	[![alt text][web]](https://rektex.github.io/) | [![alt text][github]](https://github.com/Rektex)	| | | 	(live)	| 	on-chain protocol	| 	| | | | |
...
| 	RigoBlock	| [![alt text][web]](https://rigoblock.com/) |	| | | 	(live with issues)	| 	rigoblock protocol	| | | | | |
...
|   Rippex | [![alt text][web]](https://rippex.net/carteira-ripple.php) | | | `DC` | (live) | ripple protocol | 7 | | | | |
...
| 	RuDEX	| 	[![alt text][web]](https://rudex.org/) |	| | | 	(live - beta)	| 	bitshares protocol (Graphene)	|	| | | | |
...
| Shark Relay | [![alt text][web]](https://app.sharkrelay.com/) |   | [![alt text][whitepaper]](https://sharkrelay.com/#faq) | `FULLY` `RELAY` | (live - beta) | 0x protocol |   |   |   |   |   |
| SimpleDEX | [![alt text][web]](https://simpledex.io/exchange) |	| | | 	(dev)	| 	0x protocol	|	| ERC20 Tokens | Ethereum | | |
| 	SingularX	| 	[![alt text][web]](https://ex.singularx.com/) |	| | | 	(live)	| 	TBC	|	| | | | |
|	Slow.trade	| [![alt text][web]](https://slow.trade/)	|  | [![alt text][whitepaper]](https://dutchx.readthedocs.io/en/latest) |  | 	(live)	| 	DutchX protocol	|  | ERC20 tokens | Ethereum | Gnosis | [![alt text][web]](https://dutchx.d.exchange/api/)  |
...
| Stakenet DEX | [![alt text][web]](https://stakenet.io/) | [![alt text][github]](https://github.com/X9Developers)  | [![alt text][whitepaper]](https://stakenet.io/Whitepaper_Stakenet_V3.0_EN.pdf)  | `FULLY` | (dev) | cross-chain protocol |   |   |   |   |   |
...
| Stellarport | [![alt text][web]](https://stellarport.io/) |   |   |   | (live) | stellar consensus protocol |   | | | | |
| Stellarswap | [![alt text][web]](https://stellarswap.space/) | [![alt text][github]](https://github.com/jonasess/Stellarswap) |   |   | (live) | stellar consensus protocol |   | | | | |
| 	Stellar Term	| 	[![alt text][web]](https://stellarterm.com/) |	| | | 	(live)	| 	stellar consensus protocol	| 	| | | | |
...
| Stronghold | [![alt text][web]](https://stronghold.co/) |   |   |   | (live) | stellar consensus protocol |   | | | | |
...
| 	Swap.Online	| 	[![alt text][web]](https://swap.online/) | [![alt text][github]](https://github.com/swaponline)	| [![alt text][whitepaper]](https://wiki.swap.online/en.pdf) | `FULLY` | 	(live)	| swap protocol	|	| | | | |
| 	Switcheo	| 	[![alt text][web]](http://switcheo.exchange/) | [![alt text][github]](https://github.com/ConjurTech/switcheo)	| | | 	(live)	| neo protocol	| 	| | | | |
...
| 	The World Exchange	| 	[![alt text][web]](https://www.theworldexchange.net/) | [![alt text][github]](https://github.com/pftq/TheWorldExchange/)	| | | 	(live)	| 	ripple protocol	| 	| | | | |
...
| Token Jar | [![alt text][web]](https://tokenjar.io/) |   |   | `FULLY` | (live - kovan test) | 0x protocol |   |   |   |   |   |
| Tokenlon | [![alt text][web]](https://tokenlon.token.im/tokenlon) | [![alt text][github]](https://github.com/consenlabs/tokenlon-sdk)  |   | `FULLY` | (live) | 0x protocol & Kyber.Network protocol |   |   |   |   |   |
| Tokenmon | [![alt text][web]](https://tokenmom.com/) |   |  |  `FULLY` | (live) |  | | ERC20 Tokens | Ethereum | 토큰맘 | [![alt text][web]](https://docs.tokenmom.com/#introduction) |
| 	Tokens | 	[![alt text][web]](https://www.tokens.net/) |	| | | 	(dev)	| dynamic trading rights protocol	| 	| | | | |
| 	Token Store | 	[![alt text][web]](https://token.store) |	| | | 	(live)	| TBC	|	| | | | |
|	Totle	| [![alt text][web]](https://www.totle.com/)	| [![alt text][github]](https://github.com/TotlePlatform) | [![alt text][whitepaper]](https://www.totle.com/developers) | `FULLY` | 	(live)	| 	multi protocol	| 15 |  |  | Totle Inc. | [![alt text][web]](https://www.totle.com/developers)  |
| 	Trade.io | 	[![alt text][web]](https://trade.io/) |	| [![alt text][whitepaper]](https://trade.io/whitepaper/ES.pdf) | | 	(dev)	| raiden protocol	| 	| | | | |
| 	TRON DEX | 	[![alt text][web]](http://trx.market) | [![alt text][github]](https://github.com/tronprotocol)	| | | 	(live)	| tron protocol	| 	| | | | |
...
| UberDelta |  [![alt text][web]](https://www.uberdelta.com/) | [![alt text][github]](https://github.com/UberDelta/uberdelta.github.io) | | `FULLY` | (live) | TBC | | | | | |
| 	UbiTok.io | [![alt text][web]](https://ubitok.io/) |	| | | 	(live)	| on-chain protocol	| 	| | | | |
| 	Uniswap | [![alt text][web]](https://uniswap.exchange/) | [![alt text][github]](https://github.com/Uniswap)	| [![alt text][whitepaper]](https://hackmd.io/C-DvwDSfSxuh-Gd4WKE_ig) | | 	(live)	| uniswap protocol	| | ERC20 Tokens | Ethereum | | |
...
| 	ViteX	| 	[![alt text][web]](https://wallet.vite.net/tradeCenter) |	[![alt text][github]](https://github.com/vitelabs/go-vite/tree/master/vm/contracts/dex) | | `FULLY`| (live) | 	vite protocol | 	| ALL| Vite| vite.org | |
...
| 	Waves	| 	[![alt text][web]](https://waveswallet.io) |	| | | 	(live)	| 	waves protocol (Matcher)	| 	| | | | |
...
| 	Wyvern	| 	[![alt text][web]](https://exchange.projectwyvern.com/) |	[![alt text][github]](https://github.com/ProjectWyvern/wyvern-ethereum) | [![alt text][whitepaper]](https://github.com/ProjectWyvern/wyvern-protocol/raw/master/build/whitepaper.pdf) | | 	(live - alpha)	| wyvern protocol	| 1 | non-fungible Ethereum assets  | Ethereum | | |
...
| 	xChainge	| 	[![alt text][web]](https://xchain.io/) |	| | | 	(live)	| 	counterparty protocol	| 	| | | | |
| XPA Exchange | [![alt text][web]](https://xpa.exchange/) |   |   |   | (live - beta) | TBC |   |   |   |   |   |
...
| 	Zero Exchange	| 	[![alt text][web]](http://www.zero.exchange/) |	| | | 	(live with issues)	| 	0x protocol	|	| | | | |
